...
3. Branch by task state:
   ...
   - `implementing`
     ...
     - **important**: when spawning each agent, instruct it to use semi-formal reasoning.
       Every finding must include Premises (with file:line citations), Execution/Attack/Counter
       Trace, and Conclusion. Findings without this structure should be rejected or reworked.
